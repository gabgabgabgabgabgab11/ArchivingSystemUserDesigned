...
namespace ArchivingSystemUserDesigned
{
    public partial class SearchRetrieveControl : UserControl
    {
        ...
        private void BuildUI()
        {
            ...
            var lblHeader = new Label() { Text = "Search Documents", Font = new Font("Segoe UI", 12, FontStyle.Bold), Location = new Point(30, 20), ForeColor = Color.White };
            this.Controls.Add(lblHeader);

            this.Controls.Add(new Label() { Text = "Search Term:", Location = new Point(30, 60), Size = new Size(120, 24), ForeColor = Color.White });
            txtSearch = new TextBox() { Location = new Point(150, 60), Size = new Size(260, 24) };
            this.Controls.Add(txtSearch);

            this.Controls.Add(new Label() { Text = "Category:", Location = new Point(430, 60), Size = new Size(70, 24), ForeColor = Color.White });
